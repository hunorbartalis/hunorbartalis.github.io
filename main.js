 ...
 * This file does not bundle any third-party library code itself; Font
 * Awesome and Three.js (+ its OBJLoader/MTLLoader examples) are all
...
document.querySelectorAll('.popup').forEach(img => {
  img.addEventListener('click', () => {
    // Use the high-res version for the zoomable viewer if one is provided
    // (data-full), otherwise fall back to the thumbnail's own src. The big
    // file only downloads the moment someone actually opens the image.
